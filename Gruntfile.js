...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
      ...
      concat: {
        ...
        dist: {
          src: ['js/vendor/modernizr-2.6.2.min.js', 'js/plugins.js', 'js/main.js', 'js/lodging.js', 'js/deals.js', 'js/events.js', 'js/vendor-listings.js', 'js/snow-report.js', 'js/search.js', 'js/listing-taxonomy.js', 'js/single-listing.js', 'js/press-images.js', 'js/blog.js'],
          dest: 'js/built.js',
        },
      },
