...
<?php if ( have_rows('heroes') ) : ?>
	...
	<?php while ( have_rows('heroes') ) : the_row(); ?>
		...
		<?php if (get_row_layout() == 'hero_slider') : ?>
			...
			<?php $rowCount = count(get_sub_field('hero_slide')); ?>
							...
							<?php while ( have_rows('hero_slide') ) : the_row(); ?>
								...
								<div class="slide swiper-slide">
									<div class="hero_image hero_slide_image">
										...
										<?php $mobileImage = get_sub_field('hero_image_mobile'); ?>
										<?php $video = get_sub_field('hero_video'); ?>
										<?php $typeofslide = get_sub_field('type_of_slide'); ?>
...
<iframe src="https://player.vimeo.com/video/70558178?autoplay=0&badge=0&byline=0&portrait=0&loop=1&color=ffffff" width="100%" height="100%" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe></div>
										<?php endif; ?>
									</div>
										...
										<div class="container">
											<div class="hero_copy hero_slide_copy">
												<?php if (get_sub_field('hero_title_one')) : ?>
													<h2 class="light_title"><?php the_sub_field('hero_title_one'); ?></h2>
												<?php endif; ?>
												<?php if (get_sub_field('hero_title_two')) : ?>
													<h2 class="bold_title"><?php the_sub_field('hero_title_two'); ?></h2>
												<?php endif; ?>
												<?php if (get_sub_field('hero_copy')) : ?>
													<?php the_sub_field('hero_copy'); ?>
												<?php endif; ?>
												<?php if (get_sub_field('hero_link') || get_sub_field('custom_link')) : ?>
													<?php 
													...
													?>
													<a class="arrow_cta" <?php if (get_sub_field('open_link_in_new_tab')) { echo 'target="_blank"'; } ?> href="<?php echo $link; ?>"></a>
												<?php endif; ?>
											</div><!-- end hero_copy -->
										</div><!-- end container -->
		...
		<?php elseif (get_row_layout() == 'hero_single_image') : ?>
			...
			<div class="hero_image hero_single_image">
				<?php $image = get_sub_field('hero_single_image'); ?>
				<?php $mobileImage = get_sub_field('hero_image_mobile'); ?>
				<?php $video = get_sub_field('hero_video'); ?>
